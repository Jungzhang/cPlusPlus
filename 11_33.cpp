...
void buildMap(std::map<std::string, std::string> &tran_map, std::ifstream &map_file)
{
    std::string str;
...
const std::string &transform(const std::map<std::string, std::string> &tran_map, const std::string &source)
{
...
{
    std::map<std::string, std::string> tran_map;
